package com.miljepetrovic.jobmeupapi.utils;
...
public class JwtTokenUtil {
    ...
    public String generateTokenForEmployee(EmployeeDto employeeDto, UserDetails userDetails) {
        Map<String, Object> claims = new HashMap<>();
    ...
    public String generateTokenForAdmin(AdminDto adminDto, UserDetails userDetails) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("role", "admin");
        claims.put("admin", adminDto);
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject, String id) {
        return Jwts.builder().setClaims(claims).setSubject(subject).setId(id).setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + Constants.JWT_TOKEN_VALIDITY * 1000)).setClaims(claims)
