...
public class EducationController {
    ...
    public ResponseEntity<String> deleteEducation(@PathVariable(name = "educationId")int educationId) throws NonExistingException {
        logger.info("DELETE /education/{}", educationId);
