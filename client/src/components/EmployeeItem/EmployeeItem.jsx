    ...
    <div className="employee-item">
        <div className="employee-details">
            <div className="employee-details__main">
                ...
                <div className="employee-details__main__name_location">
                    ...
                    <div className="employee-details__main__location">
                        ...
                        <div className="employee-details__main__location__text">
                            {employee.country}
                        </div>
                    </div>
                </div>
            ...
            <div className="employee-details__category">
                <div className="employee-details__category_text">
                    Category: {employee.category.name}
                </div>
            </div>
            <div className="employee-details__salary">
        ...
        <div className="employee-description">
            <div className="employee-description__about-placeholder">
                About
            </div>
...
const SkillItem = ( { name }) => {
    return(
        <li className="skill-item">{name}</li>
    )
}
